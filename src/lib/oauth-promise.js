...
module.exports = (oauthCallback) => {
  ...
  const CONSUMER_KEY = process.env.CONSUMER_KEY || 'GH8iAvOIgKIE66Zz6xANn7KSq';
  const CONSUMER_SECRET = process.env.CONSUMER_SECRET || 'abXpSUHySn9DFLeJ3XdfXhm5u7hKIUI2P2heVntkEhTnyIraIs';
